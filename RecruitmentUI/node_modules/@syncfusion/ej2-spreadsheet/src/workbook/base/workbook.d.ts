...
import { SortOptions, SortEventArgs, FindOptions, CellInfoEventArgs } from '../common/index';
...
export declare class Workbook extends Component<HTMLElement> implements INotifyPropertyChanged {
     ...
     * @returns void
     */
    hideRow(startIndex: number, endIndex?: number, hide?: boolean, sheet?: string | number): void;
    /**
     ...
     * @returns void
     */
    hideColumn(startIndex: number, endIndex?: number, hide?: boolean, sheet?: string | number): void;
    /**
     ...
     * @returns void
     */
    insertRow(startRow?: number | RowModel[], endRow?: number, sheet?: string | number): void;
    /**
     ...
     * @returns void
     */
    insertColumn(startColumn?: number | ColumnModel[], endColumn?: number, sheet?: string | number): void;
    /**
     ...
     * @returns void
     */
    delete(startIndex?: number, endIndex?: number, model?: ModelType, sheet?: string | number): void;
    /**
     ...
     * @hidden
     */
    setUsedRange(rowIdx: number, colIdx: number, sheet?: string | number): void;
    /**
