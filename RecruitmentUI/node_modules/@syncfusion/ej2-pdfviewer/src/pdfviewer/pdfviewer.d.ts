 ...
 */
export declare class FormFieldCollections extends ChildProperty<FormFieldCollections> {
    /**
 ...
 */
export declare class StampItemSettings extends ChildProperty<StampItemSettings> {
    /**
...
export declare class PdfViewer extends Component<HTMLElement> implements INotifyPropertyChanged {
     ...
     * @returns void
     */
    retrieveFormFields(): FormFieldCollectionsModel[];
    /**
